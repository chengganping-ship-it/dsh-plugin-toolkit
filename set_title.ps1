...
(function(){
  ...
  nativeSetter.call(title, "I will write ATS optimized resumes with JD keyword gap analysis");
  ...
  if (hidden) {
    ...
    hiddenSetter.call(hidden, "I will write ATS optimized resumes with JD keyword gap analysis");
    hidden.dispatchEvent(new Event("change", {bubbles: true}));
  }
  return "title: " + title.value.slice(0, 40);
})()
'@
